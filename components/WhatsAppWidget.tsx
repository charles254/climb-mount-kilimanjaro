  ...
  return (
    ...
    >
      <a
        ...
        className="group relative flex items-center justify-center w-16 h-16 bg-amber-700 hover:bg-amber-800 text-white rounded-full shadow-2xl transition-all hover:scale-110 active:scale-95"
      >
        <div className="absolute inset-0 rounded-full bg-amber-700 animate-ping opacity-20 group-hover:hidden" />
