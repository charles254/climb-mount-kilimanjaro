...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: `${article.title} | Kilimanjaro Health & Safety`,
    description: article.description,
    keywords: `Kilimanjaro safety, ${slug.replace(/-/g, ' ')}, ${article.title.toLowerCase()}`,
    alternates: {
      canonical: `/health/${slug}`
    }
  };
}
