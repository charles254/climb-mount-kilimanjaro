      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-24">
          <div className="bg-slate-900 rounded-3xl p-8 border border-slate-800 hover:border-amber-500/30 transition-all group">
            ...
            <h3 className="text-xl font-bold text-white mb-4 uppercase italic tracking-tight italic text-xl">Scenic Variety</h3>
          ...
          <div className="bg-slate-900 rounded-3xl p-8 border border-slate-800 hover:border-blue-500/30 transition-all group">
            ...
            <h3 className="text-xl font-bold text-white mb-4 uppercase italic tracking-tight italic text-xl">Difficulty Scale</h3>
          ...
          <div className="bg-slate-900 rounded-3xl p-8 border border-slate-800 hover:border-amber-500/30 transition-all group">
            ...
            <h3 className="text-xl font-bold text-white mb-4 uppercase italic tracking-tight italic text-xl">Summit Success</h3>
            <p className="text-slate-400 text-sm leading-relaxed mb-6 font-medium">
